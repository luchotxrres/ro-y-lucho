  ...
  schedule: [
    {
      ...
      icon: "M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707m12.728 0l-.707-.707M6.343 6.343l-.707-.707" // Sun/Reception
    },
    {
      time: "12:00",
      title: "Ceremonia",
    ...
    },
    {
      ...
      icon: "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" // Star/Food
    },
    {
      time: "14:00",
      title: "Momento social",
      description: "Tiempo para compartir, conversar y disfrutar de la reposición constante de islas.",
      icon: "M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2 M9 7a4 4 0 110-8 4 4 0 010 8z M23 21v-2a4 4 0 00-3-3.87 M16 3.13a4 4 0 010 7.75" // People
    },
    {
      time: "15:30",
      title: "Juegos y sorpresas",
      description: "Momentos especiales y el tradicional lanzamiento del ramo.",
      icon: "M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.921-.755 1.688-1.54 1.118l-3.976-2.888a1 1 0 00-1.175 0l-3.976 2.888c-.784.57-1.838-.197-1.539-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.382-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" // Surprise
    },
    {
      time: "16:00",
      title: "Mesa dulce y café",
      description: "Algo dulce para acompañar la tarde, con selección de cafés y tés.",
      icon: "M12 21a9 9 0 100-18 9 9 0 000 18z M8 11h8 M8 15h8" // Coffee/Cake
    },
    {
      time: "17:00",
      title: "Cierre progresivo",
      description: "Últimos brindis, charlas y despedidas pausadas.",
      icon: "M4.828 17.586L6.242 19M19.172 17.586L17.758 19M12 3v2M12 19v2M5 12H3m18 0h-2m-1.243-6.757l-1.414 1.414M6.657 6.657l1.414 1.414" // Sunset
    }
  ],
