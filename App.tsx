...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen text-wedding-text selection:bg-wedding-primary/20 selection:text-wedding-white">
      ...
      {!hasEntered ? (
        ...
        >
          ...
          >
            <div className="relative w-full max-w-2xl h-full flex items-center justify-center">
              ...
              {/* Bolsillo Frontal */}
              <div className="absolute bottom-0 left-0 w-full h-1/2 bg-wedding-primary z-20 rounded-b-sm overflow-hidden">
                <div className="absolute inset-0 paper-texture opacity-30 mix-blend-overlay"></div>
                <div
        ...
        <>
          ...
          {/* Fondo Estático para toda la App */}
          <div
          ...
          <div className="animate-reveal-app relative z-10">
            {/* Hero Section */}
            ...
            {/* Bienvenida AI */}
            <Section className="bg-wedding-bg w-full py-24 md:py-40">
              <div className="max-w-4xl mx-auto text-center px-6">
                ...
                <p className="text-wedding-text text-lg md:text-xl leading-relaxed font-light max-w-2xl mx-auto">
            ...
            <Section className="bg-wedding-white/40 backdrop-blur-md py-24 border-y border-wedding-neutral text-center">
              ...
              <p className="text-[14px] sm:text-lg md:text-2xl font-light tracking-[0.2em] md:tracking-[0.4em] italic opacity-100 drop-shadow-lg whitespace-nowrap mt-12">
                  {WEDDING_DATA.displayDate}
              </p>
            </Section>
            ...
            <Section
              id="location"
              className="bg-wedding-white w-full py-24 md:py-32 text-center"
            >
            ...
            <Section
              id="rsvp"
              className="bg-wedding-bg py-40 px-6 text-center"
            >
